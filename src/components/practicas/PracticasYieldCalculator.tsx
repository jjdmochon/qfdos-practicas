  ...
  const handleSaveToNotebook = () => {
    ...
    try {
      ...
      if (selectedPresetId === 'propranolol_step1') {
        ...
        // Auto-alimentar oxirano para etapa 2
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              textAlign: 'center',
              minWidth: 150,
              boxShadow: '0 4px 12px rgba(20, 96, 127, 0.12)'
            }}>
              ...
              <div style={{
                ...
                <div style={{ fontSize: '0.78rem', marginTop: '0.5rem', color: 'var(--text-main)' }}>
                  ...
                  {calculationData.yieldPercent >= 40 && calculationData.yieldPercent <= 80 && (
                    <span style={{ color: '#14607F', fontWeight: 600 }}>✓ Rendimiento óptimo típico de prácticas de laboratorio farmacéutico.</span>
                  )}
