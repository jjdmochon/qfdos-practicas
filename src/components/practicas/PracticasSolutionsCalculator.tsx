    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1.75rem' }}>
      ...
      {calcMode === 'liquid' && (
        <div className="grid-2-cols" style={{ display: 'grid', gridTemplateColumns: 'minmax(0, 1.2fr) minmax(0, 1fr)', gap: '1.5rem' }}>
          ...
          {/* Liquid Result Box */}
          <div className="qfdos-card" style={{ padding: '1.5rem', background: 'linear-gradient(135deg, rgba(20,96,127,0.04) 0%, rgba(192,138,46,0.04) 100%)', borderTop: '4px solid var(--teal)' }}>
            <h4 style={{ margin: '0 0 1rem 0', fontWeight: 800, fontSize: '1rem', color: 'var(--text-title)' }}>
