    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1.75rem' }}>
      ...
      <div className="grid-2-cols" style={{ display: 'grid', gridTemplateColumns: 'minmax(0, 1.35fr) minmax(0, 1fr)', gap: '1.5rem' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
          ...
          <div className="qfdos-card" style={{ padding: '1.25rem', background: 'linear-gradient(135deg, rgba(20,96,127,0.05) 0%, rgba(192,138,46,0.05) 100%)', borderLeft: '4px solid var(--teal)' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '0.5rem' }}>
